...
void writeViewState(int state) {
	...
	file << sgd_GetEntityX(pivot) << endl;
	file << sgd_GetEntityY(pivot) << endl;
	file << sgd_GetEntityZ(pivot) << endl;
	file << sgd_GetEntityRX(pivot) << endl;
	file << sgd_GetEntityRY(pivot) << endl;
	file << sgd_GetEntityRZ(pivot) << endl;
	file << sgd_GetEntityX(cam) << endl;
	file << sgd_GetEntityY(cam) << endl;
	file << sgd_GetEntityZ(cam) << endl;
	file << sgd_GetEntityRX(cam) << endl;
	file << sgd_GetEntityRY(cam) << endl;
	file << sgd_GetEntityRZ(cam) << endl;
	file.close();
